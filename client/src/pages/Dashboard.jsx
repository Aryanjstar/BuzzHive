...
const DateRangePicker = ({
  ...
  return (
    <div style={{ backgroundColor: 'black' }} className="flex items-center gap-2">
      <div style={{ backgroundColor: 'black' }} className="flex items-center gap-2">
        <input
          type="date"
          value={startDate}
...
const PerformanceCards = ({ data }) => {
  ...
  return (
    <div style={{ backgroundColor: 'white' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
      <Card>
        <CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div style={{ backgroundColor: 'white' }} className="space-y-4">
            <div style={{ backgroundColor: 'white' }} className="grid grid-cols-3 gap-4">
              <div>
...
const DataGrid = ({ data }) => {
  return (
    <Card>
      ...
      <CardContent>
        <div style={{ backgroundColor: 'white' }} className="rounded-md border overflow-x-auto">
...
const Dashboard = () => {
  ...
  return (
    <div style={{ backgroundColor: 'grey' }} className="min-h-screen bg-grey">
      <header
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            <Link
              ...
              <img src="/buzzhive.png" alt="Logo" className="h-10" />
            </Link>
      ...
      <div style={{ backgroundColor: '#B2D8D8' }} className="min-h-screen bg-background p-4 md:p-6">
        <motion.div
